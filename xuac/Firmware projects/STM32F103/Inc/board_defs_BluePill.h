...
#ifndef __BOARD_DEFS_BLUEPILL_H
#define __BOARD_DEFS_BLUEPILL_H

#include "board_caps.h" // for BOARD_CAPABILITIES

// --- Board info definitions -------------------------------------------------

#define BOARD_NAME             (uint8_t *) "Blue Pill"
...
#define PIN_USER_LED         GPIO_PIN_13
#define PORT_USER_LED        GPIOC
