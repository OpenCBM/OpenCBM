 ...
 */
#ifndef _BOARD_PROMICRO_7406_H
#define _BOARD_PROMICRO_7406_H
...
{
    uint8_t i;
    uint8_t port_base_data = (IEC_B_PORT & IO_ATN) | IO_SRQ;
    ...
    for (i = 8; i != 0; --i) {
         ...
         * being set. Write both of these to port B at the same time.
         *
         * This is 8 clock cycles with gcc 9.1.0 at both -Os and -O2.
         */
        IEC_B_PORT = (((data >> 5) & IO_DATA) ^ IO_DATA) | port_base_data;
