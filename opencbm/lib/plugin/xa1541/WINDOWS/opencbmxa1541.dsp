...
# ADD CPP /nologo /MT /W3 /GX /O2 /I "../" /I "../../../../include" /I "../../include/WINDOWS/" /I "../../../" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "DLL_EXPORTS" /YX /FD /c
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /I "../" /I "../../../../include" /I "../../../../include/WINDOWS/" /I "../../../" /I "../../../../arch/windows/" /I "$(WINDDK)\inc\wxp" /I "$(WINDDK)\inc\crt" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "DLL_EXPORTS" /FR /YX /FD /GZ /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib arch.lib winmm.lib setupapi.lib version.lib /nologo /dll /debug /machine:I386 /pdbtype:sept /libpath:"../../../../Debug"
# Begin Special Build Tool
OutDir=.\../../../../Debug
SOURCE="$(InputPath)"
PreLink_Cmds=del "$(OutDir)\opencbm-xa1541.dll"
