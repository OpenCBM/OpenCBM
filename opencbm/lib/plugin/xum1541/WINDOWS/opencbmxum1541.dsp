...
# ADD CPP /nologo /MT /W3 /GX /O2 /I "./" /I "../" /I "../../../" /I "../../../../include" /I "../../../../include/WINDOWS/" /I "../../../../../xum1541/include/" /I "../../../../arch/windows/" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "DLL_EXPORTS" /YX /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib arch.lib winmm.lib i386/libusb.lib /nologo /dll /machine:I386 /nodefaultlib:"libc.lib" /libpath:"../../../../Release"
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /I "./" /I "../" /I "../../../" /I "../../../../include" /I "../../../../include/WINDOWS/" /I "../../../../../xum1541/include/" /I "../../../../arch/windows/" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "DLL_EXPORTS" /FR /YX /FD /GZ /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib arch.lib winmm.lib i386/libusb.lib /nologo /dll /debug /machine:I386 /nodefaultlib:"libcd.lib" /pdbtype:sept /libpath:"../../../../Debug"
# Begin Special Build Tool
OutDir=.\../../../../Debug
SOURCE="$(InputPath)"
PreLink_Cmds=del "$(OutDir)\opencbm-xum1541.dll"
