...
# delete single files
for A in sys/libcommon/cbmlog.rc sys/libcommon/cbmlog.h sys/libcommon/msg00001.bin sys/libcommon/msg00002.bin mnib36/mnib1541.a65 mnib36/mnib1571.a65; do
	[ -f $A ] && rm $A
done
