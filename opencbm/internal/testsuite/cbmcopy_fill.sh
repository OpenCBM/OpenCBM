...
# $Id: cbmcopy_fill.sh,v 1.1 2006-04-15 08:56:13 wmsr Exp $
        ...
        1541)
            ...
            case $BLOCKSFREE in
		        749)	# 40 tracks format (SpeedDOS and alike)
		            FILESPEC=cbmcopy_files/?-15817141-40*.prg
            		;;
		        664)	# 35 tracks standard format
		            FILESPEC=cbmcopy_files/?-15817141-40-35.prg
            		;;
