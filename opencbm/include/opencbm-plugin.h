...
typedef int CBMAPIDECL opencbm_plugin_tap_board_info_t         (CBM_FILE HandleDevice, unsigned __int32 InfoRequest,
...
typedef int CBMAPIDECL opencbm_plugin_tap_buffer_fill_t        (CBM_FILE HandleDevice, unsigned char *Buffer, unsigned int Length, int *Status, int *BytesWritten);
typedef int CBMAPIDECL opencbm_plugin_tap_buffer_isfull_t      (CBM_FILE HandleDevice, int *Status);
typedef int CBMAPIDECL opencbm_plugin_dev_set_value32_t        (CBM_FILE HandleDevice, unsigned char ValueID, unsigned int data, int *Status);
typedef int CBMAPIDECL opencbm_plugin_dev_get_value32_t        (CBM_FILE HandleDevice, unsigned char ValueID, unsigned int *data, int *Status);
...
struct opencbm_plugin_s {
    ...
    opencbm_plugin_tap_board_info_t             * opencbm_plugin_tap_board_info;          /*!< pointer to a opencbm_plugin_tap_board_info_t() function */
    ...
    opencbm_plugin_tap_buffer_fill_t            * opencbm_plugin_tap_buffer_fill;         /*!< pointer to a opencbm_plugin_tap_buffer_fill_t() function */
    opencbm_plugin_tap_buffer_isfull_t          * opencbm_plugin_tap_buffer_isfull;       /*!< pointer to a opencbm_plugin_tap_buffer_isfull_t() function */
    opencbm_plugin_dev_set_value32_t            * opencbm_plugin_dev_set_value32;         /*!< pointer to a opencbm_plugin_dev_set_value32_t() function */
    opencbm_plugin_dev_get_value32_t            * opencbm_plugin_dev_get_value32;         /*!< pointer to a opencbm_plugin_dev_get_value32_t() function */
