...
enum O65ERR {
    ...
    O65ERR_NOT_AN_OPENCBM_MODULE          = -21,
    O65ERR_NO_MORE_DATA                   =   1 /* internal, not really an error */
} O65ERR;

extern int o65_init(void);
extern int o65_shutdown(void);
extern int o65_file_process(void *Buffer, size_t Length, void **PO65file);
